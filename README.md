...
> **Note:** The `precise` mode uses IBM Granite 8B, which requires ~16GB RAM and a GPU for reasonable speed. For machines with less memory, use `meeting` mode (default) instead.
